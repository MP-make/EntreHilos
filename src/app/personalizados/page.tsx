    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="lg:sticky lg:top-0 lg:h-screen flex items-center px-8 md:px-12 py-20 bg-white border-r border-gray-200">
            <div className="max-w-lg mx-auto lg:mx-0">
              {/* Título Principal */}
              <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-semibold text-[#5E548E] mb-6 leading-tight">
              ...
              <ul className="space-y-4 mb-12">
                <li className="flex items-start gap-3">
                  <div className="mt-1">
                    <Check size={20} className="text-[#9F86C0]" strokeWidth={2.5} />
                  </div>
                  <div>
                    <h3 className="font-lato text-base font-semibold text-[#5E548E] mb-1">
              ...
              <a 
                ...
                className="inline-flex items-center justify-center gap-3 w-full font-lato px-8 py-4 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold text-base tracking-wide transition-all duration-300 rounded shadow-lg hover:shadow-xl"
              >
