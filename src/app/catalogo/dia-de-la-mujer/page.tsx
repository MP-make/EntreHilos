        ...
        {ramos.length > 0 && (
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-10 lg:gap-x-10 lg:gap-y-14">
              {ramos.map(p => <ProductCard key={p.id} producto={p} onQuickView={handleQuickView} accentColor="#9F86C0" accentHover="#5E548E" priceColor="#9F86C0" />)}
            </div>
          </section>
        )}
        ...
        <section>
          ...
          {cajitas.length > 0 ? (
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10 lg:gap-x-10 lg:gap-y-14">
              {cajitas.map(p => <ProductCard key={p.id} producto={p} onQuickView={handleQuickView} accentColor="#9F86C0" accentHover="#5E548E" priceColor="#9F86C0" />)}
            </div>
          ) : (
