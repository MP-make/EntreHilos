...
export const DEPARTAMENTOS: Departamento[] = [
  {
    ...
    provincias: [
      ...
      { nombre: "Bagua", distritos: ["Bagua", "Aramango", "Copallín", "El Parco", "Imaza", "La Peca"] },
      ...
      { nombre: "Luya", distritos: ["Lamud", "Camporredondo", "Cocabamba", "Colcamar", "Conila", "Inguilpata", "Lámud", "Longuita", "Lonya Chico", "Luya", "Luya Viejo", "María", "Ocalli", "Ocumal", "Pisuquía", "Providencia", "San Cristóbal", "San Francisco de Yeso", "San Jerónimo", "San Juan de Lopecancha", "Santa Catalina", "Santo Tomás", "Tingo", "Trita"] },
      { nombre: "Rodríguez de Mendoza", distritos: ["Mendoza", "Chirimoto", "Cochamal", "Huambo", "Limabamba", "Longar", "Mariscal Benavides", "Milpuc", "Omia", "San Nicolás", "Santa Rosa", "Totora", "Vista Alegre"] },
  ...
  },
  {
    nombre: "Áncash",
    provincias: [
      { nombre: "Huaraz", distritos: ["Huaraz", "Cochabamba", "Colcabamba", "Huanchay", "Independencia", "Jangas", "La Libertad", "Olleros", "Pampas Grande", "Pariacoto", "Pira", "Tarica"] },
      ...
      { nombre: "Huari", distritos: ["Huari", "Anra", "Cajay", "Chavín de Huántar", "Huacachi", "Huacchis", "Huachis", "Huantar", "Masín", "Paucas", "Pontó", "Rahuapampa", "Rapayán", "San Marcos", "San Pedro de Chaná", "Uco"] },
      ...
      { nombre: "Mariscal Luzuriaga", distritos: ["Piscobamba", "Casca", "Eleazar Guzmán Barón", "Fidel Olivas Escudero", "Llama", "Llumpa", "Lucma", "Musga", "Ocros"] },
      ...
      { nombre: "Recuay", distritos: ["Recuay", "Cátac", "Cotaparaco", "Huayllapampa", "Llacllín", "Marca", "Pampas Chico", "Pararín", "Tapacocha", "Ticapampa"] },
      { nombre: "Santa", distritos: ["Chimbote", "Cáceres del Perú", "Coishco", "Macate", "Moro", "Nepeña", "Nuevo Chimbote", "Samanco", "Santa"] },
  ...
  },
  {
    ...
    provincias: [
      ...
      { nombre: "Andahuaylas", distritos: ["Andahuaylas", "Andarapa", "Chiara", "Huancarama", "Huancaray", "Huayana", "José María Arguedas", "Kaquiabamba", "Kishuara", "Pacobamba", "Pacucha", "Pampachiri", "San Antonio de Cachi", "San Jerónimo", "San Miguel de Chaccrampa", "Santa María de Chicmo", "Talavera", "Tumay Huaraca", "Turpo"] },
      ...
      { nombre: "Grau", distritos: ["Chuquibambilla", "Curasco", "Curpahuasi", "Gamarra", "Huayllati", "Mamara", "Micaela Bastidas", "Pataypampa", "Progreso", "San Antonio", "Santa Rosa", "Turpay", "Vilcabamba", "Virundo"] },
      { nombre: "Chincheros", distritos: ["Chincheros", "Anco_Huallo", "Cocharcas", "El Porvenir", "Huaccana", "Los Chankas", "Ongoy", "Ocobamba", "Ranracancha", "Rocchacc", "Uranmarca"] },
    ],
  },
  {
    nombre: "Arequipa",
  ...
  },
  {
    nombre: "Ayacucho",
    provincias: [
      { nombre: "Huamanga", distritos: ["Ayacucho", "Acocro", "Acos Vinchos", "Carmen Alto", "Chiara", "Jesús Nazareno", "Ocros", "Pacaycasa", "Quinua", "San José de Ticlias", "San Juan Bautista", "Santiago de Pischa", "Socos", "Tambillo", "Vinchos"] },
      { nombre: "Cangallo", distritos: ["Cangallo", "Chuschi", "Los Morochucos", "María Parado de Bellido", "Paras", "Totos"] },
      { nombre: "Huanca Sancos", distritos: ["Huanca Sancos", "Carapo", "Sacsamarca", "Sancos", "Santiago de Lucanamarca"] },
      { nombre: "Huanta", distritos: ["Huanta", "Ayahuanco", "Huamanguilla", "Iguain", "Llochegua", "Luricocha", "Santillana", "Sivia"] },
      { nombre: "La Mar", distritos: ["San Miguel", "Anco", "Ayna", "Chilcas", "Chungui", "Luis Carranza", "Samugari", "Santa Rosa", "Tambo", "Unión Progreso"] },
      ...
      { nombre: "Paucar del Sara Sara", distritos: ["Pausa", "Colta", "Corculla", "Lampa", "Marcabamba", "Oyolo", "Pararca", "San Javier de Alpabamba", "San José de Ushua", "Sara Sara"] },
      ...
      { nombre: "Vilcashuamán", distritos: ["Vilcashuamán", "Accomarca", "Carhuanca", "Concepción", "Huambalpa", "Independencia", "Saurama", "Vischongo"] },
    ],
  },
  {
    nombre: "Cajamarca",
    provincias: [
      { nombre: "Cajamarca", distritos: ["Cajamarca", "Asunción", "Chetilla", "Cospán", "Encañada", "Jesús", "Llacanora", "Los Baños del Inca", "Magdalena", "Matara", "Namora", "San Juan"] },
      ...
      { nombre: "Cutervo", distritos: ["Cutervo", "Callayuc", "Choros", "Cujillo", "Cutervo", "La Ramada", "Pimpingos", "Querocotillo", "San Andrés de Cutervo", "San Juan de Cutervo", "San Luis de Lucma", "Santa Cruz", "Santo Domingo de la Capilla", "Santo Tomás", "Socota", "Toribio Casanova"] },
      { nombre: "Hualgayoc", distritos: ["Bambamarca", "Chugur", "Hualgayoc"] },
      { nombre: "Jaén", distritos: ["Jaén", "Bellavista", "Chontalí", "Colasay", "Huabal", "Las Pirias", "Pacmapa", "Pomahuaca", "Pucará", "Sallique", "San Felipe", "San José del Alto", "Santa Rosa"] },
      { nombre: "San Ignacio", distritos: ["San Ignacio", "Chirinos", "Huarango", "La Coipa", "Namballe", "San José de Lourdes", "Tabaconas"] },
      { nombre: "San Marcos", distritos: ["San Marcos", "Chancay", "Eduardo Villanueva", "Gregorio Pita", "Ichocán", "José Manuel Quiroz", "José Sabogal", "Pedro Gálvez"] },
  ...
  },
  {
    ...
    provincias: [
      ...
      { nombre: "Acomayo", distritos: ["Acomayo", "Acopía", "Acos", "Mosoc Llacta", "Pomacanchi", "Rondocán", "Sangarará"] },
      { nombre: "Anta", distritos: ["Anta", "Ancahuasi", "Cachimayo", "Chinchaypujio", "Huarocondo", "Limatambo", "Mollepata", "Pucyura", "Surite", "Zurite"] },
      ...
      { nombre: "Espinar", distritos: ["Yauri", "Condoroma", "Coporaque", "Ocoruro", "Pallpata", "Pichigua", "Suyckutambo"] },
      { nombre: "La Convención", distritos: ["Quillabamba", "Cielo Punco", "Echarate", "Huayopata", "Inkawasi", "Maranura", "Megantoni", "Ocobamba", "Pichari", "Santa Ana", "Santa Teresa", "Vilcabamba", "Villa Kintiarina", "Villa Virgen"] },
  ...
  },
  {
    nombre: "Huancavelica",
    provincias: [
      { nombre: "Huancavelica", distritos: ["Huancavelica", "Acobambilla", "Acoria", "Ascensión", "Conayca", "Cuenca", "Huachocolpa", "Huando", "Huayllahuara", "Izcuchaca", "Laria", "Manta", "Mariscal Cáceres", "Moya", "Nuevo Occoro", "Palca", "Pilchaca", "Vilca", "Yauli"] },
      ...
      { nombre: "Tayacaja", distritos: ["Pampas", "Acostambo", "Acraquia", "Ahuaycha", "Colcabamba", "Daniel Hernández", "Huachocolpa", "Huaribamba", "Ñahuimpuquio", "Pazos", "Quishuar", "Roble", "Salcabamba", "Salcahuasi", "San Marcos de Rocchac", "Surcubamba", "Tintay Puncu"] },
    ],
  },
  {
    nombre: "Huánuco",
    provincias: [
      { nombre: "Huánuco", distritos: ["Huánuco", "Amarilis", "Chinchao", "Churubamba", "Margos", "Quisqui", "San Francisco de Cayrán", "San Pedro de Chaulán", "Santa María del Valle", "Yacus", "Yarumayo"] },
      { nombre: "Ambo", distritos: ["Ambo", "Cayna", "Colpas", "Conchamarca", "Huácar", "San Francisco", "San Rafael", "Tomay Kichwa"] },
      { nombre: "Dos de Mayo", distritos: ["La Unión", "Chuquis", "Marías", "Pachas", "Quivilla", "Ripán", "Shunqui", "Sillapata", "Yanas"] },
      { nombre: "Huacaybamba", distritos: ["Huacaybamba", "Canchabamba", "Cochabamba", "Pinra"] },
      { nombre: "Huamalíes", distritos: ["Llata", "Arancay", "Chavín de Pariarca", "Jacas Grande", "Jircán", "Miraflores", "Monzón", "Punchao", "Puños", "Singa", "Tantamayo"] },
      { nombre: "Leoncio Prado", distritos: ["Tingo María", "Castillo Grande", "Daniel Alomía Robles", "Hermilio Valdizán", "José Crespo y Castillo", "Luyando", "Mariano Dámaso Beraún", "Rupa-Rupa"] },
      ...
      { nombre: "Yarowilca", distritos: ["Chavinillo", "Aparicio Pomares", "Cahuac", "Chacabamba", "Chavinillo", "Jacas Chico", "Obas", "Pampamarca", "Pariarca", "Pilco", "Salcabamba"]},
    ],
  },
  {
    nombre: "Ica",
  ...
  },
  {
    ...
    provincias: [
      ...
      { nombre: "Chupaca", distritos: ["Chupaca", "Áhuac", "Chongos Bajo", "Huachac", "Huamancaca Chico", "San Juan de Jarpa", "San Juan de Yscos", "Tres de Diciembre", "Yanacancha"] },
  ...
  },
  {
    ...
    provincias: [
      ...
      { nombre: "Ascope", distritos: ["Ascope", "Chicama", "Chocope", "Magdalena de Cao", "Paiján", "Rázuri", "Santiago de Cao", "Casa Grande"] },
      ...
      { nombre: "Pataz", distritos: ["Tayabamba", "Buldibuyo", "Chillia", "Huancaspata", "Huaylillas", "Huayo", "Ongón", "Parcoy", "Pataz", "Pías", "Santa Cruz de Chuca", "Taurija", "Urpay"] },
      { nombre: "Sánchez Carrión", distritos: ["Huamachuco", "Chugay", "Cochorco", "Curgos", "Marcabal", "Sanagorán", "Sarin", "Sartimbamba"] },
  ...
  },
  {
    nombre: "Lambayeque",
    provincias: [
      { nombre: "Chiclayo", distritos: ["Chiclayo", "Chongoyape", "Eten", "Eten Puerto", "José Leonardo Ortiz", "La Victoria", "Lagunas", "Monsefú", "Nueva Arica", "Oyotún", "Pátapo", "Picsi", "Pimentel", "Pomalca", "Pucalá", "Reque", "Santa Rosa", "Saña", "Tumán"] },
      { nombre: "Ferreñafe", distritos: ["Ferreñafe", "Cañaris", "Incahuasi", "Manuel Antonio Mesones Muro", "Pitipo", "Pueblo Nuevo"] },
      { nombre: "Lambayeque", distritos: ["Lambayeque", "Chóchope", "Íllimo", "Jayanca", "Mochumí", "Mórrope", "Motupe", "Olmos", "Pacora", "Salas", "San José", "Túcume"] },
    ],
  },
  {
    nombre: "Lima",
    provincias: [
      ...
      { nombre: "Huarochirí", distritos: ["Matucana", "Antioquía", "Callahuanca", "Carampoma", "Chicla", "Cuenca", "Huachupampa", "Huanza", "Huarochirí", "Lahuaytambo", "Langa", "Laraos", "Mariatana", "Ricardo Palma", "San Andrés de Tupicocha", "San Antonio", "San Bartolomé", "San Damían", "San Juan de Iris", "San Juan de Tantaranche", "San Lorenzo de Quinti", "San Mateo", "San Mateo de Otao", "San Pedro de Casta", "San Pedro de Huancayre", "Sangallaya", "Santa Cruz de Cocachacra", "Santa Eulalia", "Santiago de Anchucaya", "Santiago de Tuna", "Santo Domingo de los Olleros", "Surco"] },
      { nombre: "Huaura", distritos: ["Huacho", "Ámbar", "Caleta de Carquín", "Checras", "Hualmay", "Huaura", "Leoncio Prado", "Paccho", "Santa Leonor", "Santa María", "Sayan", "Vegueta"] },
      { nombre: "Oyón", distritos: ["Oyón", "Andajes", "Caujul", "Cochamarca", "Naván", "Pachangara"] },
      { nombre: "Yauyos", distritos: ["Yauyos", "Alis", "Ayauca", "Ayaviri", "Azángaro", "Cacra", "Carania", "Catahuasi", "Chocos", "Cochas", "Colonia", "Hongos", "Huampara", "Huancaya", "Huañec", "Huangascar", "Huantán", "Laraos", "Lincha", "Madean", "Miraflores", "Omas", "Putinza", "Quinches", "Quinocay", "San Joaquín", "San Pedro de Pilas", "Tanta", "Tauripampa", "Tomas", "Tupe", "Viñac", "Vitis"] },
    ],
  },
  {
    nombre: "Loreto",
    provincias: [
      { nombre: "Maynas", distritos: ["Iquitos", "Alto Nanay", "Fernando Lores", "Indiana", "Las Amazonas", "Mazán", "Napo", "Punchana", "Putumayo", "San Juan Bautista", "Teniente Manuel Clavero", "Torres Causana", "Belen"] },
      { nombre: "Alto Amazonas", distritos: ["Yurimaguas", "Balsapuerto", "Barranca", "Cahuapanas", "Jeberos", "Lagunas", "Manseriche", "Morona", "Pastaza", "Santa Cruz", "Teniente César López Rojas"] },
      { nombre: "Datem del Marañón", distritos: ["San Lorenzo", "Andoas", "Barranca", "Cahuapanas", "Manseriche", "Morona", "Pastaza"] },
      { nombre: "Loreto", distritos: ["Nauta", "Parinari", "Tigre", "Trompeteros", "Urarinas"] },
      { nombre: "Mariscal Ramón Castilla", distritos: ["Caballococha", "San Pablo", "Yavari"] },
      { nombre: "Putumayo", distritos: ["Putumayo", "Rosa Panduro", "Teniente Manuel Clavero", "Yaguas"] },
      { nombre: "Requena", distritos: ["Requena", "Alto Tapiche", "Capelo", "Emilio San Martín", "Maquía", "Puinahua", "Saquena", "Soplin", "Tapiche", "Yanashi"] },
  ...
  },
  {
    ...
    provincias: [
      { nombre: "Tambopata", distritos: ["Puerto Maldonado", "Inambari", "Laberinto", "Las Piedras", "Tambopata"] },
  ...
  },
  {
    nombre: "Piura",
    provincias: [
      { nombre: "Piura", distritos: ["Piura", "Castilla", "Catacaos", "Cura Mori", "El Tallán", "La Arena", "La Unión", "Las Lomas", "Tambo Grande", "Vice"] },
      { nombre: "Ayabaca", distritos: ["Ayabaca", "Frías", "Jililí", "Lagunas", "Montero", "Pacaipampa", "Paimas", "Sapillica", "Sicchez", "Suyo"] },
      ...
      { nombre: "Morropón", distritos: ["Chulucanas", "Buenos Aires", "Chalaco", "La Matanza", "Morropón", "Salitral", "San Juan de Bigote", "Santo Domingo", "Yamango"] },
      ...
      { nombre: "Talara", distritos: ["Talara", "El Alto", "La Brea", "Lobitos", "Los Órganos", "Máncora", "Pariñas"] },
  ...
  },
  {
    nombre: "Puno",
    provincias: [
      { nombre: "Puno", distritos: ["Puno", "Ácora", "Amantaní", "Atuncolla", "Capachica", "Chucuito", "Coata", "Huata", "Mañazo", "Paucarcolla", "Pichacani", "Platería", "San Antonio", "Tiquillaca", "Vilque"] },
      ...
      { nombre: "Yunguyo", distritos: ["Yunguyo", "Capachica", "Copani", "Cuturapi", "Ollaraya", "Tinicachi", "Unicachi"] },
    ],
  },
  {
    nombre: "San Martín",
    provincias: [
      ...
      { nombre: "Rioja", distritos: ["Rioja", "Awajún", "Elías Soplin Vargas", "Nueva Cajamarca", "Pardo Miguel", "Posic", "San Fernando", "Yorongos", "Yuracyacu"] },
  ...
  },
  {
    nombre: "Tacna",
    provincias: [
      { nombre: "Tacna", distritos: ["Tacna", "Alto de la Alianza", "Calana", "Ciudad Nueva", "Coronel Gregorio Albarracín Lanchipa", "Inclán", "Pachía", "Palca", "Pocollay", "Sama", "La Yarada Los Palos"] },
  ...
  },
  {
    nombre: "Ucayali",
    provincias: [
      { nombre: "Coronel Portillo", distritos: ["Pucallpa", "Callería", "Campoverde", "Iparía", "Manantay", "Masisea", "Nueva Requena", "Yarinacocha"] },
