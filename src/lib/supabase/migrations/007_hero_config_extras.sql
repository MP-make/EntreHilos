...
VALUES
  ('home_hero_2', 'Haz que su corazón', 'lata más fuerte', 'Arreglos personalizados, globos y detalles únicos en Pisco.', 'Especial', 80, '/catalogo/cajas', ''),
  ('home_hero_3', 'Imagina tu personaje favorito', 'tejido a crochet', 'Creamos el amigurumi de tus sueños', 'Tus Personajes Favoritos', 115, '/catalogo/amigurumis', ''),
